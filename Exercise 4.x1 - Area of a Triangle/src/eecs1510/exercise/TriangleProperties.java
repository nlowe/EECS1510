 ...
 * EECS 1510 - Exercise 4 auxiliary 1
 * 
 * Calculates the side length, angle measurements, area, and perimeter
 * of a triangle given three points
 *
 */
public class TriangleProperties
{
	...
	public static void main(String[] args)
	{
		...
		System.out.printf("The the triangle formed by the points (%.2f,%.2f),(%.2f,%.2f),(%.2f,%.2f) has\n"
				...
				+ "\tan Area of: %.2f\n"
				+ "\ta Perimeter of %.2f", p1[0], p1[1], p2[0], p2[1], p3[0], p3[1], sides[0], sides[1], sides[2], angles[0], angles[1], angles[2], area, perimeter);
